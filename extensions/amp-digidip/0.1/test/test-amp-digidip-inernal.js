...
describes.fakeWin('amp-digidip', {
  ...
  let ampDoc, viewer, ampDigidip, digidipOpts, helpers;
  ...
  describe('URL shifting', () => {
    it('Should generate digidip URL base on mock data', () => {
      for (const i in mockData) {
        ...
        digidipOpts['publisher-id'] = mockData[i].publisherId;
        const elementDigidip = helpers.getAmpDigidipElement(digidipOpts);
